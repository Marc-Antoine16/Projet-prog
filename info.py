...
class Info(ctk.CTkFrame):
    ...
    def create_widgets(self):
        ...
        open = round(self.stocks[self.nom]['Open'].iloc[0].iloc[0], 2)
        ...
        self.open.grid(row = 2, column = 2, padx = (40, 0), pady = (10, 10))

        close = round(self.stocks[self.nom]['Close'].iloc[0].iloc[0], 2)
        ...
        low = round(self.stocks[self.nom]['Low'].iloc[0].iloc[0], 2)
        ...
        volume = round(self.stocks[self.nom]['Volume'].iloc[0].iloc[0], 2)
